...
module.exports = function createEnvironment () {
  ...
  function link (value) {
    var name = 'g' + gCounter
    if(typeof value === 'object' && value.name) name = value.name.replace(/ /g, '_')
  ...
  function compile () {
    ...
    var linkedNames = []
    var linkedValues = []
    Object.keys(linkedItems).sort().forEach(function (name) {
      var value = linkedItems[name]
      linkedNames.push(name)
      linkedValues.push(value)
    })

    var key = linkedNames.join()
    ...
    if(!proc) {
      ...
      // copy functions after viewing parcoords then scattergl with errorbars
      //console.log(str)
